...
##         as og:image)
TWITTER_IMAGE = BASE_URL + '/images/midorino_logo.svg'
...
CLUE_TEXT_FOR_LINKED_IMAGES = {
                                ...
                                'french': '(cliquer pour une version plus large)'
                              }
